function oneOffSetting() { 
  ...
  cGoa.GoaApp.setPackage (
    ...
    cGoa.GoaApp.createPackageFromFile (DriveApp , {
      ...
      fileId:'0B92ExLh4POiZVEt5YzQ2WkFQT0U',
...
function doGet(e) {     
  ...
  // if this is running as the user, then the project properties
  // can be cloned to make a token infrastructure for each user
  // that way, their own token refreshes and choices are specific to them
  // so this time we use the UserPropertiesStore  
  ...
  .setTitle('Web app Oauth2 as user')
